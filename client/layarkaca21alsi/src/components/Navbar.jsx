...
import { fetchSearchMovies } from '../store/actions/actionMovies';
            ...
            <ul className={` md:flex-row md:flex md:items-center md:pb-0 pb-12 absolute md:static lg:bg-none bg-[#e50914] md:z-auto z-[-1] left-0 w-3/6 md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${isOpen ? 'left-0' : 'left-[-490px]'} `}>
                ...
                <div className='relative'>
                    {/* <form onSubmit={() => handleSearch}> */}
                        <input type="text" value={search} onChange={searchValue} name='search' placeholder='search' className='bg-white h-10 rounded-lg text-sm focus:outline-none md:ml-8 w-11/12 p-2' />
                        <button type='button' onClick={handleSearch} className='absolute right-5 top-0 mt-3 mr-2 lg:right-0'>
                        <div className='px-3'>
