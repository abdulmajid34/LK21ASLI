...
function Videos({ setShowModal, video }) {
  return (
    <>
      ...
      <div className=" w-screen delay-700 duration-500 ease-in-out  justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
