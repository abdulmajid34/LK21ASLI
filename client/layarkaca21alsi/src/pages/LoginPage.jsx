  ...
  return (
    <section className="flex flex-col md:flex-row h-screen">
            <div className=" hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
                <div className=' w-full h-full object-cover' style={{ backgroundImage: `url(${imgLK21ASLI})` }}>
                ...
                <div className="w-full h-100">
                    ...
                    >
                        <div>
                          ...
                          />
                            {errors.email && <p className=' text-xs text-red-600 mt-1'>This field is required</p>}
                        </div>
